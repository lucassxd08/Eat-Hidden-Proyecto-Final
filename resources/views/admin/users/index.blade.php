                ...
                <tr class="hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4">
                        @php
                            $roleColors = [
                                ...
                                'kitchen'  => 'bg-yellow-900 text-yellow-300',
                                'delivery' => 'bg-blue-900 text-blue-300',
                    ...
                    <td class="px-6 py-4 text-center">
                        <div class="flex justify-center gap-2">
                            <a href="{{ route('admin.users.edit', $user) }}" class="text-blue-400 hover:underline text-xs font-medium">Editar</a>
                            @if($user->id !== auth()->id())
