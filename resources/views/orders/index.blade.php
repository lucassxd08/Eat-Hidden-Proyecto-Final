...
<div class="max-w-4xl mx-auto px-4 py-10">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('orders.menu') }}" class="bg-orange-500 hover:bg-orange-600 text-white font-semibold px-5 py-2.5 rounded-lg transition">
            + Nuevo pedido
        </a>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow mb-4 p-6 flex items-center justify-between">
        ...
        <div class="text-right">
            <p class="font-bold text-orange-500 text-lg">S/ {{ number_format($order->total, 2) }}</p>
    ...
    <div class="text-center py-20">
        ...
        <a href="{{ route('orders.menu') }}" class="inline-block mt-4 bg-orange-500 text-white font-semibold px-6 py-3 rounded-xl hover:bg-orange-600 transition">
